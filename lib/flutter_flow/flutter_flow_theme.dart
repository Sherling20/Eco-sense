...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF486D1A);
  late Color secondary = const Color(0xFF7CA100);
  late Color tertiary = const Color(0xFFFAB919);
  late Color alternate = const Color(0xFFFFDA50);
